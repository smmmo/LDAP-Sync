...
//	public static LdapProperty FIRSTNAME = new LdapProperty("FIRSTNAME", "FIRSTNAME");
//	public static LdapProperty LASTNAME = new LdapProperty("LASTNAME", "LASTNAME");
//	public static LdapProperty TELEPHONE = new LdapProperty("TELEPHONE", "TELEPHONE");
//	public static LdapProperty MOBILE = new LdapProperty("MOBILE", "MOBILE");
//	public static LdapProperty HOMEPHONE = new LdapProperty("HOMEPHONE", "HOMEPHONE");
//	public static LdapProperty MAIL = new LdapProperty("MAIL", "MAIL");
//	public static LdapProperty PHOTO = new LdapProperty("PHOTO", "PHOTO");
//	public static LdapProperty STREET = new LdapProperty("STREET", "STREET");
//	public static LdapProperty CITY = new LdapProperty("CITY", "CITY");
//	public static LdapProperty STATE = new LdapProperty("STATE", "STATE");
//	public static LdapProperty ZIP = new LdapProperty("ZIP", "ZIP");
//	public static LdapProperty COUNTRY = new LdapProperty("COUNTRY", "COUNTRY");
	...
	public static Contact valueOf(ReadOnlyEntry user, Bundle mB) {
		...
		try {
			c.setDn(user.getDN());
//			c.setFirstName(user.hasAttribute(FIRSTNAME.getActiveLdapName()) ? user.getAttributeValue(FIRSTNAME.getActiveLdapName()) : null);
